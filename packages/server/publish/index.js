  ...
  "../../node_modules/.pnpm/sql.js@1.13.0/node_modules/sql.js/dist/sql-wasm.js"(exports, module) {
    ...
    var initSqlJs2 = function(moduleConfig) {
      ...
      initSqlJsPromise = new Promise(function(resolveModule, reject) {
        ...
        f.onRuntimeInitialized = function() {
          ...
          function b(g, l) {
            for (var n = [], r = 0; r < g; r += 1) {
              var t2 = m(l + 4 * r, "i32"), y = hc(t2);
              if (1 === y || 2 === y) t2 = ic(t2);
              else if (3 === y) t2 = jc(t2);
              else if (4 === y) {
                y = t2;
                t2 = kc(y);
                y = lc(y);
                for (var L = new Uint8Array(t2), J = 0; J < t2; J += 1) L[J] = p[y + J];
                t2 = L;
              } else t2 = null;
              n.push(t2);
            }
          ...
          function e(g) {
            ...
            if (null != g) {
              ...
              if (g) {
                if ("string" == typeof g) {
                  n = Array(g.length);
                  for (var t2 = 0, y = g.length; t2 < y; ++t2) n[t2] = g.charCodeAt(t2);
                  g = n;
                }
                na(r, l | 146);
                n = oa(r, 577);
          ...
          var h = z4(4), k = f.cwrap, q = k("sqlite3_open", "number", ["string", "number"]), w = k("sqlite3_close_v2", "number", ["number"]), v = k("sqlite3_exec", "number", ["number", "string", "number", "number", "number"]), C = k("sqlite3_changes", "number", ["number"]), G = k("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]), pb = k("sqlite3_sql", "string", ["number"]), nc = k("sqlite3_normalized_sql", "string", ["number"]), qb = k("sqlite3_prepare_v2", "number", ["number", "number", "number", "number", "number"]), oc = k("sqlite3_bind_text", "number", ["number", "number", "number", "number", "number"]), rb = k("sqlite3_bind_blob", "number", ["number", "number", "number", "number", "number"]), pc = k("sqlite3_bind_double", "number", ["number", "number", "number"]), qc = k(
            "sqlite3_bind_int",
            "number",
          ...
          c.prototype.get = function(g, l) {
            ...
            for (var n = vc(this.Qa), r = 0; r < n; r += 1) switch (zc(this.Qa, r)) {
              case 1:
                var t2 = l.useBigInt ? this.Gb(r) : this.wb(r);
                g.push(t2);
                break;
              case 2:
                g.push(this.wb(r));
            ...
            try {
              ...
              for (g = []; 0 !== m(y, "i8"); ) {
                ...
                if (0 !== J) {
                  var I = null;
                  t2 = new c(J, this);
                  for (null != l && t2.bind(l); t2.step(); ) null === I && (I = { columns: t2.getColumnNames(), values: [] }, g.push(I)), I.values.push(t2.get(null, n));
                  t2.free();
                }
              }
              return g;
          ...
          e.prototype.each = function(g, l, n, r, t2) {
          ...
          e.prototype.create_aggregate = function(g, l) {
            ...
            if (!t2) throw "An aggregate function must have a step function in " + g;
            var y = {};
          ...
          e.prototype.updateHook = function(g) {
            ...
            g && (this.Ya = Aa(function(l, n, r, t2, y) {
              switch (n) {
                case 18:
                  l = "insert";
                  break;
        ...
        var Db = (a, b) => (Db = Z.Ga)(a, b), Wc = (a, b) => (Wc = Z.Ha)(a, b), wa = (a) => (wa = Z.Ia)(a), z4 = (a) => (z4 = Z.Ja)(a), sa = () => (sa = Z.Ka)();
        f.stackSave = () => sa();
...
var import_sql, RALPHBAN_DIR, DB_FILENAME;
...
async function runHttpServer() {
  ...
  const webDistInDir = path3.resolve(__dirname2, "web-dist");
  const webDistInParent = path3.resolve(__dirname2, "..", "web-dist");
